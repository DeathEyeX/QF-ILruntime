...
namespace QFramework.ILRuntime
{
    ...
    {
        public class ILTypeEventUnregister<T> : ICanDispose
        {
        ...
        /// 接口 只负责存储在字典中
        /// </summary>
        interface IRegisterations : ICanDispose
        {
            void Dispose();
        ...
        public static ICanDispose Register<T>(System.Action<T> onReceive)
        {
        ...
        public ICanDispose RegisterEvent<T>(Action<T> onReceive)
        {
            var type = typeof(T);
