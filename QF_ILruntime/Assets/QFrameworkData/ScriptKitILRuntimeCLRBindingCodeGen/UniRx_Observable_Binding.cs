...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UniRx_Observable_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, EveryUpdate_0);
            args = new Type[]{typeof(System.TimeSpan)};
            method = type.GetMethod("Timer", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Timer_1);


        }


        static StackObject* EveryUpdate_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* Timer_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
