...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Net_Dns_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetHostEntry_0);


        }


        static StackObject* GetHostEntry_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
