...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UniRx_ObservableExtensions_Binding
    {
        ...
        static StackObject* Subscribe_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Action<UniRx.Unit> @onNext = (System.Action<UniRx.Unit>)typeof(System.Action<UniRx.Unit>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.IObservable<UniRx.Unit> @source = (System.IObservable<UniRx.Unit>)typeof(System.IObservable<UniRx.Unit>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
